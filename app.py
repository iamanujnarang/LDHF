...
<div class="footer-container">
  <div class="made-with-love">
    Made with <span class="heart-symbol">❤️</span> by 
    <b>Anuj Narang, JE PSPCL</b>
  </div>

  <div style="margin-bottom: 25px;">
    <a href="https://instagram.com/iamanujnarang" target="_blank">
      <img src="YOUR_INSTA_ICON_URL" class="social-icon">
    </a>
    <a href="https://facebook.com/iamanujnarang" target="_blank">
      <img src="YOUR_FB_ICON_URL" class="social-icon">
    </a>
    <a href="https://x.com/iamanujnarang" target="_blank">
      <img src="YOUR_X_ICON_URL" class="social-icon">
    </a>
    <a href="https://linkedin.com/in/iamanujnarang" target="_blank">
      <img src="YOUR_LINKEDIN_ICON_URL" class="social-icon">
    </a>
  </div>
  ...
  <div class="beeclue-box">
    ...
    <a href="https://beeclue.com" target="_blank">
      <img src="https://beeclue.com/wp-content/uploads/2023/09/logo.png" 
           alt="Beeclue Logo" 
           class="beeclue-img">
    </a>
  </div>
